<section class="join__team">
    <div class="container join__team-inner">
        <div class="join__team-content">
            ...
            <form method="post" action="{{ route('send_hh_form')}}" class="join__team-form join__team-form--bg">
                ...
                <label class="join__team-label">
                    <input type="text" name="name" placeholder="Ваше ФИО" class="join__team-input">
                </label>
                <label class="join__team-label">
                    <input type="tel" required name="phone" placeholder="Телефон" class="join__team-input phone-mask">
                </label>
