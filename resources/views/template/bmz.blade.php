...
@section('main')
    ...
    <section>
        <div class="container">
            <h2 class="section-title clients__title">Этапы работы над проектом</h2>
            <div class="advantages-list">

                @foreach ( $sections['Этапы работы над проектом'] as $item)
    ...
    <section>
        <div class="container">
            <h2 class="section-title clients__title">Сферы применения БМЗ</h2>
            <div class="icon-cards">
                @foreach ( $sections['Сферы применения БМЗ'] as $item)
