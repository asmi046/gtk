            ...
            [
                ...
                'sections' => json_encode([
                    ...
                    [
                        ...
                        'sub_title' => '02',
                        'content' => 'Конструкции изготавливаются в соответствии с ГОСТ, выдерживают серьёзные эксплуатационные нагрузки и подходят для многоэтажного и промышленного строительства.',
                    ],
                    ...
                    [
                        ...
                        'sub_title' => '03',
                        'content' => 'Собственное проектное бюро, позволяет проводить расчет конструкций., а используемые проверенные технологии и сертифицированные материалы - гарантируют длительные сроки службы.',
                    ]
                ])
            ],
