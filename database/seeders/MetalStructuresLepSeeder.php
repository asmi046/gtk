...
class MetalStructuresLepSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            [
                'title' => "Конструкции линий электропередачи",
                'order' => 2,
                'sub_title' => "Стальные конструкции и комплектующие для ЛЭП",
                ...
                'sections' => json_encode([
                    ...
                    [
                        ...
                        'sub_title' => '02',
                        'content' => 'Опоры устойчивы к различным видам нагрузок (ветровым, снеговым и тп.) и эксплуатируются в разных климатических зонах на территории РФ',
                    ],
